...
let AccountPage = class AccountPage {
    constructor(statusBar, config, api, navCtrl, settings, platform, appRate, emailComposer, socialSharing) {
    ...
    log_out() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.api.postItem('logout').subscribe(res => { }, err => {
                console.log(err);
            });
    ...
    getCustomer() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.platform.is('hybrid'))
                yield this.api.getItemIonic('customers/' + this.settings.customer.id).then((res) => {
                ...
                yield this.api.getItem('customers/' + this.settings.customer.id).subscribe(res => {
                    this.settings.customer = res;
                    loading.dismiss();
                }, err => {
                    console.log(err);
...
let BlogPage = class BlogPage {
    ...
    getPost() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.getPosts('/wp-json/wp/v2/posts/' + this.id + '?_embed').subscribe(res => {
                this.post.post = res;
            }, err => {
                console.log(err);
            });
    ...
    getComments() {
        this.api.getPosts('/wp-json/wp/v2/comments?post=' + this.id + '&page=' + this.commentFilter.page).subscribe(res => {
            this.comments = res;
        }, err => {
            console.log(err);
        });
...
let BlogsPage = class BlogsPage {
    ...
    getPosts() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.getPosts('/wp-json/wp/v2/posts?_embed&per_page=10&page=' + this.filter.page).subscribe(res => {
                if (res)
                    this.posts = res;
                else
                    this.posts.posts = [];
...
let CurrenciesPage = class CurrenciesPage {
    ...
    applyCurrency() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.api.ajaxCall('/wp-admin/admin-ajax.php', this.params).subscribe((res) => {
            });
            this.home.getBlocks();
            this.navCtrl.pop();
        });
...
let EditAddressPage = class EditAddressPage {
    ...
    getCountries() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postItem('countries').subscribe(res => {
                this.countries = res;
    ...
    updateAddress() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.api.postItem('update-address', this.address).subscribe(res => {
                this.status = res;
                // this.navCtrl.pop();
                this.disableButton = false;
            }, err => {
...
let ForgottenPage = class ForgottenPage {
    constructor(api, loadingController, navCtrl, settings, fb) {
        this.api = api;
        this.loadingController = loadingController;
        this.navCtrl = navCtrl;
        this.settings = settings;
    ...
    forgotten() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.api.postItem('email-otp', this.email.value).subscribe(res => {
                this.status = res;
    ...
    resetPassword() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.disableSubmit = true;
            yield this.api.postItem('reset-user-password', this.form.value).subscribe(res => {
                this.status = res;
...
let LoginPage = class LoginPage {
    constructor(platform, oneSignal, api, settings, loadingController, router, navCtrl, fb, googlePlus, facebook) {
        this.platform = platform;
    ...
    onSubmit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.disableSubmit = true;
            yield this.api.postItem('login', this.form.value).subscribe(res => {
                this.status = res;
            ...
            self.api.postItem('create-user', userData).subscribe(res => {
                ...
                if (self.status.errors) {
                    ...
                    if (self.platform.is('cordova'))
                        self.oneSignal.getIds().then((data) => {
...
let MapPage = class MapPage {
    ...
    ngAfterViewInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postItem('locations').subscribe(res => {
...
let OrderPage = class OrderPage {
    ...
    refundKey() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postItem('woo_refund_key').subscribe(res => {
                this.refundKeys = res;
    ...
    requestRefund() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.api.postItem('woo_refund_key', this.refund).subscribe(res => {
...
let OrdersPage = class OrdersPage {
    ...
    getOrders() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postFlutterItem('orders', this.filter).subscribe(res => {
                this.orders = res;
            }, err => {
                console.log(err);
            });
...
let PointsPage = class PointsPage {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postItem('getPointsHistory').subscribe((res) => {
                this.points = res;
...
let RegisterPage = class RegisterPage {
    ...
    onSubmit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.disableSubmit = true;
            yield this.api.postItem('create-user', this.form.value).subscribe(res => {
                this.status = res;
                if (this.status.errors) {
                    this.errors = this.status.errors;
                    this.disableSubmit = false;
...
let WalletPage = class WalletPage {
    ...
    getWallet() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postItem('wallet').subscribe(res => {
                this.wallet = res;
                console.log(res);
            }, err => {
                console.log(err);
...
let WishlistPage = class WishlistPage {
    ...
    getWishlist() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postItem('get_wishlist').subscribe(res => {
                this.wishlist = res;
            }, err => {
                console.log(err);
            });
...
let CartPage = class CartPage {
    constructor(translate, alertCtrl, toastController, config, api, data, router, settings, loadingController, navCtrl, route, productData) {
        this.translate = translate;
    ...
    getCart() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postItem('cart').subscribe(res => {
                this.cart = res;
                this.data.updateCart(this.cart.cart_contents);
            }, err => {
                console.log(err);
    ...
    deleteItem(itemKey, qty) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postItem('remove_cart_item&item_key=' + itemKey).subscribe(res => {
                this.cart = res;
                this.data.updateCart(this.cart.cart_contents);
            }, err => {
                console.log(err);
    ...
    addToCart(id, item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (item.value.manage_stock && (item.value.stock_quantity <= item.value.quantity)) {
                ...
                yield this.api.postItem('update-cart-item-qty', params).subscribe(res => {
                    this.cart = res;
                    this.data.updateCart(this.cart.cart_contents);
                }, err => {
                    console.log(err);
    ...
    onSubmit(userData) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.api.postItem('login', this.loginForm).subscribe(res => {
                this.status = res;
...
let CategoriesPage = class CategoriesPage {
    constructor(api, data, loadingController, navCtrl, router, settings, route) {
        this.api = api;
        this.data = data;
        this.loadingController = loadingController;
        this.navCtrl = navCtrl;
...
let CheckoutAddressPage = class CheckoutAddressPage {
    ...
    getCheckoutForm() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.loader = true;
            yield this.api.postItem('get_checkout_form').subscribe(res => {
    ...
    updateOrderReview() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postItem('update_order_review').subscribe(res => {
...
let CheckoutPage = class CheckoutPage {
    ...
    updateOrder() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.api.updateOrderReview('update_order_review', this.checkoutData.form).subscribe(res => {
    ...
    placeOrder() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.checkoutData.form.payment_method == 'stripe') {
                this.setStripeForm();
                yield this.api.getExternalData('https://api.stripe.com/v1/tokens', this.stripeForm).subscribe(res => {
                ...
                yield this.api.ajaxCall('/checkout?wc-ajax=checkout', this.checkoutData.form).subscribe(res => {
                    this.results = res;
                    this.handleOrder();
                }, err => {
                    this.disableButton = false;
                    ...
                    if (this.stripeStatus.redirect.indexOf('confirm-pi-') != -1) {
                        ...
                        this.stripe.handleCardPayment(clientSecret, this.cardElement, {
                            ...
                            if (result.error) {
                                ...
                                this.api.ajaxCall('/?wc-ajax=wc_stripe_verify_intent&order=' + order_id + '&nonce=' + this.checkoutData.form.stripe_confirm_pi + '&redirect_to=').subscribe(res => {
                                    this.navCtrl.navigateRoot('/order-summary/' + order_id);
                                }, err => {
                                });
                            }
...
let ProductPage = class ProductPage {
    ...
    getProduct() {
        this.api.postFlutterItem('product', { 'product_id': this.id }).subscribe(res => {
            this.product = res;
            this.handleProduct();
        }, err => {
            console.log(err);
    ...
    getGroupedProducts() {
        if (this.product.grouped_products.length) {
            ...
            this.api.getItem('products', filter).subscribe(res => {
    ...
    getRelatedProducts() {
        ...
        this.api.postFlutterItem('product_details', filter).subscribe(res => {
            this.relatedProducts = res;
        }, err => { });
    }
    getReviews() {
        this.api.postFlutterItem('product_reviews', { 'product_id': this.product.id }).subscribe(res => {
            this.reviews = res;
    ...
    addToCart() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.product.manage_stock && this.product.stock_quantity < this.data.cart[this.product.id]) {
                ...
                this.disableButton = true;
                yield this.api.postItem('add_to_cart', this.options).subscribe(res => {
                    this.results = res;
    ...
    updateToCart(product) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (product.manage_stock && product.stock_quantity < this.data.cart[product.id]) {
                ...
                yield this.api.updateCart('/cart/', params).subscribe(res => {
                    console.log(res);
                    this.cart = res;
                    this.data.updateCart(this.cart.cart_contents);
                }, err => {
...
let ReviewPage = class ReviewPage {
    ...
    loadData(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.filter.page = this.filter.page + 1;
            yield this.api.postFlutterItem('product_reviews', this.filter).subscribe(res => {
    ...
    onSubmit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.disableSubmit = true;
            yield this.api.ajaxCall('/wp-comments-post.php', this.form.value).subscribe(res => {
                this.disableSubmit = false;
            }, err => {
                this.disableSubmit = false;
            });
...
let EditOrderPage = class EditOrderPage {
    ...
    getOrder() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield loading.present();
            if (this.platform.is('hybrid'))
                yield this.api.getItemIonic('orders/' + this.id).then((res) => {
                    this.orders = res;
                    loading.dismiss();
                }, err => {
                    console.log(err);
                ...
                yield this.api.getItem('orders/' + this.id).subscribe(res => {
                    this.orders = res;
                    loading.dismiss();
                }, err => {
                    console.log(err);
    ...
    save() {
        this.disableButton = true;
        if (this.platform.is('hybrid'))
            this.api.postItemIonic('orders/' + this.id, this.orders).then((res) => {
                this.disableButton = false;
...
let EditProductPage = class EditProductPage {
    ...
    getProduct() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.getItem('products/' + this.id).subscribe(res => {
                this.product = res;
                this.handleProduct();
            }, err => {
                console.log(err);
    ...
    getVariationProducts() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.getItem('products/' + this.product.id + '/variations').subscribe(res => {
                this.variations = res;
            }, err => { });
        });
    }
    getRelatedProducts() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.product.related_ids != 0) {
                ...
                yield this.api.getItem('products', filter).subscribe(res => {
                    this.relatedProducts = res;
                }, err => { });
            }
        });
    ...
    getReviews() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.getItem('products/' + this.product.id + '/reviews').subscribe(res => {
                this.reviews = res;
                for (let item in this.reviews) {
                    this.reviews[item].avatar = Object(_md5__WEBPACK_IMPORTED_MODULE_8__["md5"])(this.reviews[item].email);
                }
    ...
    saveProduct() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.platform.is('hybrid'))
                yield this.api.putItemIonic('products/' + this.id, this.product).then((res) => {
                    this.product = res;
                    this.productData.product = {};
                ...
                yield this.api.put('products/' + this.id, this.product).subscribe(res => {
                    this.product = res;
                    this.productData.product = {};
                    this.navCtrl.navigateBack('/tabs/account/vendor-products');
                }, err => {
...
let OrderListPage = class OrderListPage {
    ...
    getWooCommerceProductVendorOrders() {
        this.api.postItem('vendor-order-list', this.filter).subscribe(res => {
            this.orders = res;
            this.loader = false;
        }, err => {
            console.log(err);
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const actionSheet = yield this.actionSheetController.create({
                ...
                buttons: [{
                        ...
                        icon: 'checkmark',
                        handler: () => {
                            this.api.postItem('set_fulfill_status', { status: 'fulfilled', order_item_id: order.order_item_id }).subscribe(res => {
                        ...
                        icon: 'close',
                        handler: () => {
                            this.api.postItem('set_fulfill_status', { status: 'unfulfilled', order_item_id: order.order_item_id }).subscribe(res => {
                                order.fulfillment_status = res;
                            }, err => {
                                console.log(err);
                            });
...
let PhotosPage = class PhotosPage {
    ...
    submit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.loading.present();
            if (this.platform.is('hybrid')) {
                this.api.postItemIonic('products', this.vendor.product).then((res) => {
                ...
                this.api.wcpost('products', this.vendor.product).subscribe(res => {
                    //DOKAN AND WCFM Plugin
                    this.res = res;
                    this.api.postItem('update-vendor-product', {
                        id: this.res.id
...
let ProductListPage = class ProductListPage {
    ...
    loadData(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.filter.page = this.filter.page + 1;
            if (this.platform.is('hybrid'))
                yield this.api.getItemIonic('products', this.filter).then((res) => {
                    this.tempProducts = res;
                    this.products.push.apply(this.products, this.tempProducts);
                    event.target.complete();
                    if (this.tempProducts.length == 0)
                ...
                yield this.api.getItem('products', this.filter).subscribe(res => {
                    this.tempProducts = res;
                    this.products.push.apply(this.products, this.tempProducts);
                    event.target.complete();
                    if (this.tempProducts.length == 0)
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const alert = yield this.alertController.create({
                ...
                buttons: [{
                        ...
                        handler: () => {
                            if (this.platform.is('hybrid'))
                                this.api.deleteItemIonic('products', product.id).then((res) => {
                                    this.getProducts();
                                }, err => {
                                    console.log(err);
                                });
                            else
                                this.api.deleteItem('products', product.id).subscribe(res => {
                                    this.getProducts();
                                }, err => {
                                    console.log(err);
                                });
...
let VendorListPage = class VendorListPage {
    ...
    getVendors() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postItem('vendors', this.filter).subscribe(res => {
                this.vendors = res;
            }, err => {
                console.log(err);
            });
    ...
    getWcVendors() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.platform.is('hybrid'))
                yield this.api.WCMPVendorIonic('vendors', this.filter).then((res) => {
                    this.vendors = res;
                }, err => {
                    console.log(err);
                });
            else
                yield this.api.WCMPVendor('vendors', this.filter).subscribe(res => {
                    this.vendors = res;
                }, err => {
                    console.log(err);
                });
    ...
    getDokanVendors() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postItem('vendors-list', this.filter).subscribe(res => {
                this.vendors = res;
            }, err => {
                console.log(err);
            });
    ...
    getWCFMVendors() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postItem('wcfm-vendor-list', this.filter).subscribe(res => {
                this.vendors = res;
            }, err => {
                console.log(err);
            });

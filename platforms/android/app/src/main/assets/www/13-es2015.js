...
/* harmony import */ var _utils_6acbf959_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils-6acbf959.js */ "./node_modules/@ionic/core/dist/esm/utils-6acbf959.js");
...
const Icon = class {
    ...
    loadIcon() {
        if ( this.isVisible) {
            const url = Object(_utils_6acbf959_js__WEBPACK_IMPORTED_MODULE_2__["g"])(this);
            if (url) {
        ...
        if (!this.ariaLabel) {
            const label = Object(_utils_6acbf959_js__WEBPACK_IMPORTED_MODULE_2__["a"])(this.name, this.icon, this.mode, this.ios, this.md);
    ...
    render() {
        ...
        return (Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_0__["H"], { role: "img", class: Object.assign(Object.assign({ [mode]: true }, createColorClasses(this.color)), { [`icon-${this.size}`]: !!this.size, 'flip-rtl': !!flipRtl && this.el.ownerDocument.dir === 'rtl' }) }, (( this.svgContent)

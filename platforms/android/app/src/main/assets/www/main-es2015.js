...
let ApiService = class ApiService {
    constructor(http, config, ionicHttp) {
        this.http = http;
        this.config = config;
    ...
    getBlocks() {
        ...
        return this.http.get(url, this.config.options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(`getBlocks`)));
    }
    getItem(endPoint, filter = {}) {
        const url = this.config.setUrl('GET', '/wp-json/wc/v3/' + endPoint + '?', filter);
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(endPoint)));
    }
    deleteItem(endPoint, id) {
        const url = this.config.setUrl('DELETE', '/wp-json/wc/v3/' + endPoint + "/" + id + '?', {});
        return this.http.delete(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(endPoint)));
    }
    postFlutterItem(endPoint, data = {}) {
        ...
        return this.http.post(url, params, this.config.options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(endPoint)));
    }
    ...
    getItemMstore(endPoint, filter = {}) {
        const url = this.config.url + '/wp-admin/admin-ajax.php?action=mstoreapp-' + endPoint;
        return this.http.get(url, this.config.options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(endPoint)));
    }
    ...
    getPosts(endPoint) {
        return this.http.get(this.config.url + endPoint).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(endPoint)));
    }
    ...
    put(endPoint, data, params = {}) {
        ...
        return this.http.put(url, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(endPoint)));
    }
    wcpost(endPoint, data, params = {}) {
        const url = this.config.setUrl('POST', '/wp-json/wc/v3/' + endPoint + '?', params);
        return this.http.post(url, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(endPoint)));
    }
...
ApiService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _config__WEBPACK_IMPORTED_MODULE_5__["Config"], _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_6__["HTTP"]])
], ApiService);
...
/* harmony import */ var _checkout_order_summary_order_summary_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./checkout/order-summary/order-summary.page */ "./src/app/checkout/order-summary/order-summary.page.ts");
...
const routes = [
    ...
    { path: 'order-summary/:id', component: _checkout_order_summary_order_summary_page__WEBPACK_IMPORTED_MODULE_3__["OrderSummaryPage"] },
];
...
/* harmony import */ var _ionic_native_app_minimize_ngx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic-native/app-minimize/ngx */ "./node_modules/@ionic-native/app-minimize/ngx/index.js");
...
let AppComponent = class AppComponent {
    constructor(config, alertController, router, navCtrl, translateService, platform, splashScreen, statusBar, appMinimize) {
        this.config = config;
...
/* harmony import */ var _ionic_native_app_rate_ngx__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ionic-native/app-rate/ngx */ "./node_modules/@ionic-native/app-rate/ngx/index.js");
/* harmony import */ var _ionic_native_app_minimize_ngx__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ionic-native/app-minimize/ngx */ "./node_modules/@ionic-native/app-minimize/ngx/index.js");
...
/* harmony import */ var _app_pipes_pipe_module__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../app/pipes/pipe.module */ "./src/app/pipes/pipe.module.ts");
...
/* harmony import */ var _home_home_page__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./home/home.page */ "./src/app/home/home.page.ts");
/* harmony import */ var _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @ionic-native/http/ngx */ "./node_modules/@ionic-native/http/ngx/index.js");
/* harmony import */ var _ionic_native_google_plus_ngx__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @ionic-native/google-plus/ngx */ "./node_modules/@ionic-native/google-plus/ngx/index.js");
/* harmony import */ var _ionic_native_facebook_ngx__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @ionic-native/facebook/ngx */ "./node_modules/@ionic-native/facebook/ngx/index.js");
/* harmony import */ var _ionic_native_image_picker_ngx__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @ionic-native/image-picker/ngx */ "./node_modules/@ionic-native/image-picker/ngx/index.js");
...
/* harmony import */ var _app_filter_filter_page__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../app/filter/filter.page */ "./src/app/filter/filter.page.ts");
/* harmony import */ var _checkout_order_summary_order_summary_page__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./checkout/order-summary/order-summary.page */ "./src/app/checkout/order-summary/order-summary.page.ts");
/* harmony import */ var _ionic_native_firebase_analytics_ngx__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! @ionic-native/firebase-analytics/ngx */ "./node_modules/@ionic-native/firebase-analytics/ngx/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _app_filter_filter_page__WEBPACK_IMPORTED_MODULE_28__["FilterPage"],
            _checkout_order_summary_order_summary_page__WEBPACK_IMPORTED_MODULE_29__["OrderSummaryPage"]
            //HomePage
        ],
        entryComponents: [
            _app_filter_filter_page__WEBPACK_IMPORTED_MODULE_28__["FilterPage"],
        ...
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"],
            ...
            _app_pipes_pipe_module__WEBPACK_IMPORTED_MODULE_18__["KeysPipeModule"],
        ...
        providers: [
            ...
            _ionic_native_firebase_analytics_ngx__WEBPACK_IMPORTED_MODULE_30__["FirebaseAnalytics"],
            _home_home_page__WEBPACK_IMPORTED_MODULE_21__["HomePage"],
            //Braintree,
            _ionic_native_google_plus_ngx__WEBPACK_IMPORTED_MODULE_23__["GooglePlus"],
            _ionic_native_facebook_ngx__WEBPACK_IMPORTED_MODULE_24__["Facebook"],
            ...
            _ionic_native_app_minimize_ngx__WEBPACK_IMPORTED_MODULE_12__["AppMinimize"],
            _ionic_native_email_composer_ngx__WEBPACK_IMPORTED_MODULE_13__["EmailComposer"],
            _ionic_native_app_rate_ngx__WEBPACK_IMPORTED_MODULE_11__["AppRate"],
...
let OrderSummaryPage = class OrderSummaryPage {
    ...
    getOrder() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.api.postFlutterItem('order', this.filter).subscribe(res => {
                this.order = res;
                loading.dismiss();
            }, err => {
                console.log(err);
...
OrderSummaryPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./order-summary.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/checkout/order-summary/order-summary.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./order-summary.page.scss */ "./src/app/checkout/order-summary/order-summary.page.scss")).default]
    }),
...
let Settings = class Settings {
    constructor(translate, api, toastController) {
    ...
    addToWishlist(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.customer.id) {
                ...
                yield this.api.postItem('add_wishlist', {
                    product_id: id
                }).subscribe(res => {
                    this.wishlist = [];
                    for (let item in res) {
...
Settings = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslateService"], _api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ToastController"]])
], Settings);
...
let FilterPage = class FilterPage {
    constructor(api, loadingController, modalCtrl, settings, navParams) {
        this.api = api;
        this.loadingController = loadingController;
    ...
    ngOnInit() {
        ...
        if (this.filter.min_price) {
            ...
            this.price.upper = this.settings.settings.max_price;
    }
    dismiss() {
    ...
    applyFilter() {
        ...
        for (const [key, value] of Object.entries(this.attributes)) {
            if (this.attributes[key].terms.length)
                this.attributes[key].terms.forEach(term => {
...
FilterPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-filter',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./filter.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/filter/filter.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./filter.page.scss */ "./src/app/filter/filter.page.scss")).default]
    }),
...
let HomePage = class HomePage {
    constructor(config, api, splashScreen, platform, translateService, data, settings, product, loadingController, router, navCtrl, route, oneSignal, nativeStorage, firebaseAnalytics) {
        this.config = config;
        this.api = api;
        this.splashScreen = splashScreen;
        this.platform = platform;
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pipe */ "./src/app/pipes/pipe.ts");
/* harmony import */ var _datepipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./datepipe */ "./src/app/pipes/datepipe.ts");
...
module.exports = __webpack_require__(/*! D:\wootop\WooToop-AppAndroid\src\main.ts */"./src/main.ts");
